...
def main(argv):
    ...
    for P_s_index in range(len(P_s)):
            ...
            if n > 0:
                ...
                for mu_su_subset in it.combinations(mu_su,n):
                    ...
                    sum_anal_throughput += prod_capa_s_r_throughput * prod_capa_s_r_outage \
                        * (1 - gaussian_approximation(n * K_u, K_d, rician_K_D, r_s, zeta, p_u, sigma_u/mu_ud_max, 20))
                    ...
                    capacity_e = (1 - zeta) * channel_ue_expected_adapt(p_u, K_u, K_e, sigma_e, rician_K_E, n, N, mu_ue_max, mu_je_max)
        ...
        adapt_sec_anal[P_s_index] = np.max([sum_anal_d_cap - sum_anal_e,0])
