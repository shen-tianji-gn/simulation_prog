...
def main(argv):
    ...
    axes.set_xlim([3,10])
    axes.set_ylim([5e-5,1])
    # plt.locator_params(axis="x",nbins=4)
    plt.grid(True, which='major', linestyle='-', alpha=0.6)
    plt.grid(True, which='minor', linestyle=':', alpha=0.3)
    plt.xlabel('Threshold Rate $R_s$ (bit/s/Hz)', \
        fontdict={'size':16})
    ...
    plt.savefig('rs_d.eps',bbox_inches="tight", pad_inches = 0.05)
    plt.savefig('rs_d.png',bbox_inches="tight", pad_inches = 0.05)
