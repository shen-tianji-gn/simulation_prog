...
def main(argv):
    ...
    plt.savefig('ps_e.eps',bbox_inches="tight", pad_inches = 0.05)
    plt.savefig('ps_e.png',bbox_inches="tight", pad_inches = 0.05)
