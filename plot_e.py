...
def main(argv):
    ...
    #E
    # # fixed part
    # x, rician_10_fixed_k_5_n_5_anal_e_best = file_read(10,'fixed',5,5,'anal','e',type='best')
    # x, rician_10_fixed_k_5_n_5_simu_e_best = file_read(10,'fixed',5,5,'simu','e',type='best')
    # x, rician_10_fixed_k_5_n_8_anal_e_best = file_read(10,'fixed',5,8,'anal','e',type='best')
    # x, rician_10_fixed_k_5_n_8_simu_e_best = file_read(10,'fixed',5,8,'simu','e',type='best')
    # x, rician_10_fixed_k_5_n_11_anal_e_best = file_read(10,'fixed',5,11,'anal','e',type='best')
    # x, rician_10_fixed_k_5_n_11_simu_e_best = file_read(10,'fixed',5,11,'simu','e',type='best')
    # x, rician_10_fixed_k_8_n_5_anal_e_best = file_read(10,'fixed',8,5,'anal','e',type='best')
    # x, rician_10_fixed_k_8_n_5_simu_e_best = file_read(10,'fixed',8,5,'simu','e',type='best')
    # x, rician_10_fixed_k_8_n_8_anal_e_best = file_read(10,'fixed',8,8,'anal','e',type='best')
    # x, rician_10_fixed_k_8_n_8_simu_e_best = file_read(10,'fixed',8,8,'simu','e',type='best')
    # x, rician_10_fixed_k_8_n_11_anal_e_best = file_read(10,'fixed',8,11,'anal','e',type='best')
    # x, rician_10_fixed_k_8_n_11_simu_e_best = file_read(10,'fixed',8,11,'simu','e',type='best')
    # x, rician_10_fixed_k_11_n_5_anal_e_best = file_read(10,'fixed',11,5,'anal','e',type='best')
    # x, rician_10_fixed_k_11_n_5_simu_e_best = file_read(10,'fixed',11,5,'simu','e',type='best')
    # x, rician_10_fixed_k_11_n_8_anal_e_best = file_read(10,'fixed',11,8,'anal','e',type='best')
    # x, rician_10_fixed_k_11_n_8_simu_e_best = file_read(10,'fixed',11,8,'simu','e',type='best')
    # x, rician_10_fixed_k_11_n_11_anal_e_best = file_read(10,'fixed',11,11,'anal','e',type='best')
    # x, rician_10_fixed_k_11_n_11_simu_e_best = file_read(10,'fixed',11,11,'simu','e',type='best')

    # # adaptive part
    # x, rician_10_adapt_k_5_n_5_anal_e_best = file_read(10,'adapt',5,5,'anal','e',type='best')
    # x, rician_10_adapt_k_5_n_5_simu_e_best = file_read(10,'adapt',5,5,'simu','e',type='best')
    # x, rician_10_adapt_k_5_n_8_anal_e_best = file_read(10,'adapt',5,8,'anal','e',type='best')
    # x, rician_10_adapt_k_5_n_8_simu_e_best = file_read(10,'adapt',5,8,'simu','e',type='best')
    # x, rician_10_adapt_k_5_n_11_anal_e_best = file_read(10,'adapt',5,11,'anal','e',type='best')
    # x, rician_10_adapt_k_5_n_11_simu_e_best = file_read(10,'adapt',5,11,'simu','e',type='best')
    # x, rician_10_adapt_k_8_n_5_anal_e_best = file_read(10,'adapt',8,5,'anal','e',type='best')
    # x, rician_10_adapt_k_8_n_5_simu_e_best = file_read(10,'adapt',8,5,'simu','e',type='best')
    # x, rician_10_adapt_k_8_n_8_anal_e_best = file_read(10,'adapt',8,8,'anal','e',type='best')
    # x, rician_10_adapt_k_8_n_8_simu_e_best = file_read(10,'adapt',8,8,'simu','e',type='best')
    # x, rician_10_adapt_k_8_n_11_anal_e_best = file_read(10,'adapt',8,11,'anal','e',type='best')
    # x, rician_10_adapt_k_8_n_11_simu_e_best = file_read(10,'adapt',8,11,'simu','e',type='best')
    # x, rician_10_adapt_k_11_n_5_anal_e_best = file_read(10,'adapt',11,5,'anal','e',type='best')
    # x, rician_10_adapt_k_11_n_5_simu_e_best = file_read(10,'adapt',11,5,'simu','e',type='best')
    # x, rician_10_adapt_k_11_n_8_anal_e_best = file_read(10,'adapt',11,8,'anal','e',type='best')
    # x, rician_10_adapt_k_11_n_8_simu_e_best = file_read(10,'adapt',11,8,'simu','e',type='best')
    # x, rician_10_adapt_k_11_n_11_anal_e_best = file_read(10,'adapt',11,11,'anal','e',type='best')
    # x, rician_10_adapt_k_11_n_11_simu_e_best = file_read(10,'adapt',11,11,'simu','e',type='best')
    ...
    plt.xlabel('Transmit Power $P_{\mathtt{S}}$ (dBm)', \
        fontdict={'size':16})
    plt.ylabel('Estimated Average Transmission Capacity at ${\mathtt{E}}$ (kb/s)', \
        fontdict={'size':16})
    ...
    # fixed
    # K=5,N=5, K = 10
    # plt.plot(x,rician_10_fixed_k_5_n_5_anal_e_best,color=[0.6350, 0.0780, 0.1840], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # red

    # plt.plot(x,rician_10_fixed_k_5_n_5_simu_e_best,color=[0.6350, 0.0780, 0.1840], \
    #     linestyle = 'None', marker = 'o', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K}=5, {N}=5$, Fixed, Best') # red
    ...
    ## K=5,N=11
    # plt.plot(x,rician_10_fixed_k_5_n_11_anal_e_worst,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # yellow

    # plt.plot(x,rician_10_fixed_k_5_n_11_simu_e_worst,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = 'None', marker = '^', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K_U}=5, {N}=11$, Fixed ') # yellow

    ## K=8,N=5
    # plt.plot(x,rician_10_fixed_k_8_n_5_anal_e_best,color=[0.4660, 0.6740, 0.1880], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # green

    # plt.plot(x,rician_10_fixed_k_8_n_5_simu_e_best,color=[0.4660, 0.6740, 0.1880], \
    #     linestyle = 'None', marker = '+', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K}=8, {N}=5$, Fixed') # green

    # ## K=8,N=11
    # plt.plot(x,rician_10_fixed_k_8_n_11_anal_e_best,color=[0.3010, 0.7450, 0.9330], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # cyan

    # plt.plot(x,rician_10_fixed_k_8_n_11_simu_e_best,color=[0.3010, 0.7450, 0.9330], \
    #     linestyle = 'None', marker = 'x', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K}=8, {N}=11$, Fixed') # cyan

    # K=11,N=5
    # plt.plot(x,rician_10_fixed_k_4_n_5_anal_e_best,color=[0, 0.4470, 0.7410], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # blue

    # plt.plot(x,rician_10_fixed_k_4_n_5_simu_e_best,color=[0, 0.4470, 0.7410], \
    #     linestyle = 'None', marker = 's', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K_{\mathtt{U}}}=11, {N}=5$, Fixed') # blue

    plt.plot(x,rician_10_fixed_k_4_n_5_anal_e_worst,color=[0, 0.4470, 0.7410], \
        linestyle = '-', marker = 'None', markerfacecolor='None',\
        linewidth = 2, markersize = 10) # blue

    plt.plot(x,rician_10_fixed_k_4_n_5_simu_e_worst,color=[0, 0.4470, 0.7410], \
        linestyle = 'None', marker = 's', markerfacecolor='None',\
        linewidth = 2, markersize = 10, \
        label = '${K_{\mathtt{U}}}=4, {N}=5$, Fixed') # blue

    # # K=11,N=11
    # plt.plot(x,rician_10_fixed_k_11_n_11_anal_e_worst,color=[0.4940, 0.1840, 0.5560], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # purple

    # plt.plot(x,rician_10_fixed_k_11_n_11_simu_e_worst,color=[0.4940, 0.1840, 0.5560], \
    ...
    # adapt
    # K=5,N=5
    plt.plot(x,rician_10_adapt_k_2_n_5_anal_e_worst,color=[0.9290, 0.6940, 0.1250], \
        linestyle = '--', marker = 'None', markerfacecolor='None',\
        linewidth = 2, markersize = 10) # red

    plt.plot(x,rician_10_adapt_k_2_n_5_simu_e_worst,color=[0.9290, 0.6940, 0.1250], \
        linestyle = 'None', marker = '<', markerfacecolor='None',\
        linewidth = 2, markersize = 10, \
        label = '${K_{\mathtt{U}}}=2, {N}=5$, Adaptive') # red
    
    # K=5,N=8
    # plt.plot(x,rician_10_adapt_k_5_n_8_anal_e_best,color=[0, 0.4470, 0.7410], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # blue

    # plt.plot(x,rician_10_adapt_k_5_n_8_simu_e_best,color=[0, 0.4470, 0.7410], \
    #     linestyle = 'None', marker = 's', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K}=5, {N}=8$') # blue
    
    # K=5,N=11
    # plt.plot(x,rician_10_adapt_k_5_n_11_anal_e_worst,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = '--', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # yellow

    # plt.plot(x,rician_10_adapt_k_5_n_11_simu_e_worst,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = 'None', marker = '>', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K_U}=5, {N}=11$, Adaptive') # yellow

    # # K=8,N=5
    # plt.plot(x,rician_10_adapt_k_8_n_5_anal_e_best,color=[0.4660, 0.6740, 0.1880], \
    #     linestyle = ':', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # green

    # plt.plot(x,rician_10_adapt_k_8_n_5_simu_e_best,color=[0.4660, 0.6740, 0.1880], \
    #     linestyle = 'None', marker = '+', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K}=8, {N}=5$, Adaptive') # green

    # # K=8,N=11
    # plt.plot(x,rician_10_adapt_k_8_n_11_anal_e_best,color=[0.3010, 0.7450, 0.9330], \
    #     linestyle = ':', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # cyan

    # plt.plot(x,rician_10_adapt_k_8_n_11_simu_e_best,color=[0.3010, 0.7450, 0.9330], \
    #     linestyle = 'None', marker = 'x', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    ...
    # # K=11,N=11
    # plt.plot(x,rician_10_adapt_k_11_n_11_anal_e_worst,color=[0.4940, 0.1840, 0.5560], \
    #     linestyle = '--', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # purple

    # plt.plot(x,rician_10_adapt_k_11_n_11_simu_e_worst,color=[0.4940, 0.1840, 0.5560], \
    #     linestyle = 'None', marker = '3', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K_U}=11, {N}=11$, Adaptive') # purple

    # plt.plot(x,pure_y_6,color=[0, 0.4470, 0.7410], \
    #     linestyle = '-', marker = 's', markerfacecolor='none',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${\sf K}=6, {\sf N}=6$') # blue

    # plt.plot(x,pure_y_8,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = '-', marker = '+', markerfacecolor='none',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${\sf K}=8, {\sf N}=8$') # yellow
    ...
    # # fixed
    # axins.plot(x,rician_10_fixed_k_5_n_5_anal_e_best,color=[0.6350, 0.0780, 0.1840], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10)
    # axins.plot(x,rician_10_fixed_k_5_n_5_simu_e_best,color=[0.6350, 0.0780, 0.1840], \
    #     linestyle = 'None', marker = 'o', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K}=5, {N}=5$, Fixed') # red

    # # adapt
    # axins.plot(x,rician_10_adapt_k_5_n_5_anal_e_best,color=[0.6350, 0.0780, 0.1840], \
    #     linestyle = ':', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10)
    # axins.plot(x,rician_10_adapt_k_5_n_5_simu_e_best,color=[0.6350, 0.0780, 0.1840], \
    #     linestyle = 'None', marker = '<', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K}=5, {N}=5$, Fixed') # red
    ...
    # # fixed
    # axins.plot(x,rician_10_fixed_k_5_n_11_anal_e_best,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # yellow

    # axins.plot(x,rician_10_fixed_k_5_n_11_simu_e_best,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = 'None', marker = '^', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '${K}=5, {N}=11$, Fixed') # yellow

    # # adapt
    # axins.plot(x,rician_10_adapt_k_5_n_11_anal_e_best,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = ':', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # yellow

    # axins.plot(x,rician_10_adapt_k_5_n_11_simu_e_best,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = 'None', marker = '>', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    ...
    plt.savefig('result_e_capacity_hybrid_5.eps',bbox_inches="tight", pad_inches = 0.05)
    plt.savefig('result_e_capacity_hybrid_5.png',bbox_inches="tight", pad_inches = 0.05)
