...
def main(argv):
    ...
    # K=5
    x5_f1, rician_10_fixed_k_2_alpha_5_anal_sec_w = file_read_new(10,'fixed',2, 0.5,'anal','secrecy',type='worst')
    # x5_f2, rician_10_fixed_k_2_alpha_25_anal_sec_w = file_read_new(10,'fixed',5, 0.25,'anal','secrecy',type='worst')
    # x5_f3, rician_10_fixed_k_2_alpha_75_anal_sec_w = file_read_new(10,'fixed',5, 0.75,'anal','secrecy',type='worst')

    # K=11
    x11_f1, rician_10_fixed_k_4_alpha_5_anal_sec_w = file_read_new(10,'fixed',4, 0.5,'anal','secrecy',type='worst')
    # x11_f2, rician_10_fixed_k_11_alpha_25_anal_sec_w = file_read_new(10,'fixed',11, 0.25,'anal','secrecy',type='worst')
    # x11_f3, rician_10_fixed_k_11_alpha_75_anal_sec_w = file_read_new(10,'fixed',11, 0.75,'anal','secrecy',type='worst')


    # adaptive part
    x5_a, rician_10_adapt_k_2_anal_sec_w = file_read(10,'adapt',2,'anal','secrecy',type='worst')
    x11_a, rician_10_adapt_k_4_anal_sec_w = file_read(10,'adapt',4,'anal','secrecy',type='worst')
    ...
    plt.xticks(np.arange(2,12,2),size=14)
    ...
    plt.plot(x11_f1,rician_10_fixed_k_2_alpha_5_anal_sec_w,color=[0.6350, 0.0780, 0.1840], \
        linestyle = '-', marker = 'None', markerfacecolor='None',\
        linewidth = 2, markersize = 10, \
        label = '$M = \\lceil \\frac{1}{2} N \\rceil$, $K_{\mathtt{U}} = 2$, Fixed') # red
    ## K=5,N=8
    # plt.plot(x11_f2,rician_10_fixed_k_11_alpha_25_anal_sec_w,color=[0, 0.4470, 0.7410], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10,\
    #     label = '$M = \\lceil \\frac{1}{4} \\rceil N$, $K_{\mathtt{U}} = 11$, Fixed') # blue

    # plt.plot(x11_f3,rician_10_fixed_k_11_alpha_75_anal_sec_w,color=[0.4660, 0.6740, 0.1880], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10,\
    #     label = '$M = \\lceil \\frac{3}{4} \\rceil N$, $K_{\mathtt{U}} = 11$, Fixed') # green
    ...
    # ## K=8,N=11
    plt.plot(x5_f1,rician_10_fixed_k_4_alpha_5_anal_sec_w,color=[0.3010, 0.7450, 0.9330], \
        linestyle = '-', marker = 'None', markerfacecolor='None',\
        linewidth = 2, markersize = 10, \
        label = '$M = \\lceil \\frac{1}{2} N \\rceil $, $K_{\mathtt{U}} = 4$, Fixed') # cyan

    # plt.plot(x5_f2,rician_10_fixed_k_5_alpha_25_anal_sec_w,color='pink', \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '$M = \\lceil \\frac{1}{4} \\rceil N$, $K_{\mathtt{U}} = 5$, Fixed') # pink

    # plt.plot(x5_f3,rician_10_fixed_k_5_alpha_75_anal_sec_w,color='grey', \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10, \
    #     label = '$M = \\lceil \\frac{3}{4} \\rceil N$, $K_{\mathtt{U}} = 5$, Fixed') # grey
    ...
    ## K=11,N=5
    # plt.plot(x11_f1,rician_10_fixed_k_11_alpha_5_anal_sec_w,color=[0, 0.4470, 0.7410], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10,
    ...
    # plt.plot(x11_f3,rician_10_fixed_k_11_alpha_75_anal_sec_w,color=[0, 0.4470, 0.7410], \
    #     linestyle = '-', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10,
    #     label = '${K_U}=11, {N}=5$, Fixed') # blue
    ...
    # adapt
    ## K=5,N=5
    # plt.plot(x5_a,rician_10_adapt_k_5_anal_sec_w,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = '--', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10,\
    #     label = '$K_{\mathtt{U}} = 5$, Adaptive') # red
    # plt.plot(x5_a,rician_10_adapt_k_5_anal_sec_w,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = '--', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10,\
    #     label = '$K_{\mathtt{U}} = 5$, Adaptive') # red
    ...
    # K=5,N=11
    plt.plot(x5_a,rician_10_adapt_k_2_anal_sec_w,color=[0.9290, 0.6940, 0.1250], \
        linestyle = '--', marker = 'None', markerfacecolor='None',\
        linewidth = 2, markersize = 10,\
        label = '${K_{\mathtt{U}}}=2$, Adaptive') # yellow

    plt.plot(x11_a,rician_10_adapt_k_4_anal_sec_w,color=[0, 0.4470, 0.7410], \
        linestyle = '--', marker = 'None', markerfacecolor='None',\
        linewidth = 2, markersize = 10,\
        label = '${K_{\mathtt{U}}}=4$, Adaptive') # yellow
    # plt.plot(x11_a,rician_10_adapt_k_11_anal_sec_w,color=[0.9290, 0.6940, 0.1250], \
    #     linestyle = '--', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10,\
    #     label = '${K_{\mathtt{U}}}=11$, Adaptive') # yellow
