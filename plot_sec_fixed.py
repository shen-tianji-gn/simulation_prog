...
def main(argv):
    ...
    plt.savefig('result_sec_capacity_fixed.eps',bbox_inches="tight", pad_inches = 0.05)
    plt.savefig('result_sec_capacity_fixed.png',bbox_inches="tight", pad_inches = 0.05)
