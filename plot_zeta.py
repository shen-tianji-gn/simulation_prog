    ...
    if not np.any(type_D == type_set):
        ...
        if np.any(type_D == adapt_set):
            ...
            if d_or_e != 'd':
                ...
                file_name = open('result_txts/zeta/RicianK=' + str(Rician_K) \
...
def main(argv):
    ...
    # K=10
    # x, rician_10_fixed_k_5_n_5_anal_sec_w = file_read(10,'fixed',5,5,'simu','secrecy',type='worst')
    x_1, rician_10_fixed_k_2_n_5_simu_sec_w = file_read(10,'fixed_op',2,5,'simu','secrecy',type='worst')
    # x, rician_10_fixed_k_5_n_11_anal_sec_w = file_read(10,'fixed',5,11,'simu','secrecy',type='worst')
    # x, rician_10_fixed_k_5_n_11_simu_sec_w = file_read(10,'fixed',5,11,'simu','secrecy',type='worst')
    # x, rician_10_fixed_k_11_n_5_anal_sec_w = file_read(10,'fixed',11,5,'simu','secrecy',type='worst')
    x_2, rician_10_fixed_k_4_n_5_simu_sec_w = file_read(10,'fixed_op',4,5,'simu','secrecy',type='worst')
    # x, rician_10_fixed_k_11_n_11_anal_sec_w = file_read(10,'fixed',11,11,'simu','secrecy',type='worst')
    # x, rician_10_fixed_k_11_n_11_simu_sec_w = file_read(10,'fixed',11,11,'simu','secrecy',type='worst')

    # adaptive part
    # x, rician_10_adapt_k_5_n_5_anal_sec_w = file_read(10,'adapt',5,5,'simu','secrecy',type='worst')
    x_3, rician_10_adapt_k_2_n_5_simu_sec_w = file_read(10,'adapt_op',2,5,'simu','secrecy',type='worst')
    # x, rician_10_adapt_k_5_n_11_anal_sec_w = file_read(10,'adapt',5,11,'simu','secrecy',type='worst')
    # x, rician_10_adapt_k_5_n_11_simu_sec_w = file_read(10,'adapt',5,11,'simu','secrecy',type='worst')
    # x, rician_10_adapt_k_11_n_5_anal_sec_w = file_read(10,'adapt',11,5,'simu','secrecy',type='worst')
    x_4, rician_10_adapt_k_4_n_5_simu_sec_w = file_read(10,'adapt_op',4,5,'simu','secrecy',type='worst')
    # x, rician_10_adapt_k_11_n_11_anal_sec_w = file_read(10,'adapt',11,11,'simu','secrecy',type='worst')
    # x, rician_10_adapt_k_11_n_11_simu_sec_w = file_read(10,'adapt',11,11,'simu','secrecy',type='worst')
    
    for _ in range(len(rician_10_adapt_k_2_n_5_simu_sec_w)):
        rician_10_adapt_k_2_n_5_simu_sec_w[_] = rician_10_adapt_k_2_n_5_simu_sec_w[_] / 6.3135436
        rician_10_adapt_k_4_n_5_simu_sec_w[_] = rician_10_adapt_k_4_n_5_simu_sec_w[_] / 6.3135436


    dummy_y = np.zeros(len(x_1))
    ...
    plt.plot(x_1,rician_10_fixed_k_2_n_5_simu_sec_w,color=[0.6350, 0.0780, 0.1840], \
        linestyle = '-', marker = 'None', markerfacecolor='None',\
        linewidth = 2, markersize = 10, \
    ...
    plt.plot(x_2,rician_10_fixed_k_4_n_5_simu_sec_w,color=[0.9290, 0.6940, 0.1250], \
        linestyle = '-', marker = 'None', markerfacecolor='None',\
        linewidth = 2, markersize = 10, \
    ...
    # adapt
    ## K=5,N=5
    # plt.plot(x,rician_10_adapt_k_5_n_5_anal_sec_w,color=[0.6350, 0.0780, 0.1840], \
    #     linestyle = '--', marker = 'None', markerfacecolor='None',\
    #     linewidth = 2, markersize = 10) # red

    plt.plot(x_3,rician_10_adapt_k_2_n_5_simu_sec_w,color=[0.6350, 0.0780, 0.1840], \
        linestyle = '--', marker = 'None', markerfacecolor='None',\
        linewidth = 2, markersize = 10, \
    ...
    plt.plot(x_4,rician_10_adapt_k_4_n_5_simu_sec_w,color=[0.9290, 0.6940, 0.1250], \
        linestyle = '--', marker = 'None', markerfacecolor='None',\
        linewidth = 2, markersize = 10, \
    ...
    plt.savefig('result_sec_capacity_zeta.eps',bbox_inches="tight", pad_inches = 0.05)
    plt.savefig('result_sec_capacity_zeta.png',bbox_inches="tight", pad_inches = 0.05)
