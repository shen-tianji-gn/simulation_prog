...
def main(argv):
    ...
    plt.xlabel('$\zeta$', \
        fontdict={'size':16})
    plt.ylabel('Throughput Probability at $\mathtt{D}$', \
        fontdict={'size':16})
    ...
    plt.savefig('result_zeta_d.eps',bbox_inches="tight", pad_inches = 0.05)
    plt.savefig('result_zeta_d.png',bbox_inches="tight", pad_inches = 0.05)
